...
public class EmployeeFormController implements Initializable {
    ...
    void btnAddOnAction(ActionEvent event) {
        boolean isAdded = EmployeeController.getInstance().addEmployee(new Employee(txtID.getText(), txtName.getText(), txtCompany.getText(), txtEmail.getText()));
    ...
    void btnUpdateOnAction(ActionEvent event) {
        boolean isUpdated = EmployeeController.getInstance().updateEmployee(new Employee(txtID.getText(), txtName.getText(), txtCompany.getText(), txtEmail.getText()));
